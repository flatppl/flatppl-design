...
**Stan** ([Carpenter et al., 2017](16-references.md#carpenter2017)) is the strongest candidate for longevity: it has a large and active user and developer community, bindings for multiple languages (R, Python, Julia and others), and solid funding. However:
...
**SlicStan** ([Gorinova et al., 2019](16-references.md#gorinova2019)) introduced compositional, blockless Stan with an information-flow type system
...
**Hakaru** ([Narayanan et al., 2016](16-references.md#narayanan2016)) has elegant semantics built on the
...
([Böck et al., 2024](16-references.md#boeck2024)) demonstrates that a cross-PPL abstraction layer is
achievable, though its IR is too minimal for our needs. [Fenske et al. (2025)](16-references.md#fenske2025)
...
HS³ JSON document or a RooFit workspace, though FlatPPL concepts like random draws and measure/function reification do not currently exist in HS³ and RooFit. See the [profiles and interoperability](11-profiles.md#sec:profiles) section on how FlatPPL maps to them.
