...
For a categorical over arbitrary labels (strings or other values) rather than integer
indices, superpose Diracs at the labels:
`normalize(ksuperpose(Dirac, p)(labels))` (see
